...
1. Built-in logic functions
    ...
    1. `all()` and `any()` functions in R can be used to check if all or any values in a vector evaluate to TRUE for some expression. Return is a single `TRUE` or `FALSE`.
